...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/assets/boilerplate/css/app.css') }}" />
    <style>
        .color-purple {
            color: #6777ef;
        }
...
<script type="text/javascript" src="{{ asset('/assets/boilerplate/js/app.js') }}"></script>
</body>
</html>
